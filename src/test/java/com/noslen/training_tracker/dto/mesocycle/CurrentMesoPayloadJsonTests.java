...
public class CurrentMesoPayloadJsonTests {
    ...
    void setUp() {
        ...
        // Create day notes and muscle groups
        ...
        // Create a list of days for a week
    ...
    void testSerialize() throws IOException {
        ...
        assertThat(json.write(currentMesoPayload)).extractingJsonPathStringValue("$.key").isEqualTo("wzzidovd6137");
        ...
        // Test nested structure - first week
        assertThat(json.write(currentMesoPayload)).hasJsonPathArrayValue("$.weeks");
        
        // Test first day in first week
        assertThat(json.write(currentMesoPayload)).hasJsonPathArrayValue("$.weeks[0].days");
        assertThat(json.write(currentMesoPayload)).extractingJsonPathNumberValue("$.weeks[0].days[0].id").isEqualTo(19749536);
        
        // Test first exercise in first day
        assertThat(json.write(currentMesoPayload)).hasJsonPathArrayValue("$.weeks[0].days[0].exercises");
        assertThat(json.write(currentMesoPayload)).extractingJsonPathNumberValue("$.weeks[0].days[0].exercises[0].id").isEqualTo(121219664);
        
        // Test notes
        assertThat(json.write(currentMesoPayload)).hasJsonPathArrayValue("$.notes");
        assertThat(json.write(currentMesoPayload)).extractingJsonPathNumberValue("$.notes[0].id").isEqualTo(13571);
        
        // Test status and generatedFrom
        assertThat(json.write(currentMesoPayload)).extractingJsonPathStringValue("$.status").isEqualTo("ready");
        assertThat(json.write(currentMesoPayload)).extractingJsonPathStringValue("$.generatedFrom").isEqualTo("Thor Workout");
        
        // Test progressions
        assertThat(json.write(currentMesoPayload)).hasJsonPath("$.progressions");
        assertThat(json.write(currentMesoPayload)).extractingJsonPathNumberValue("$.progressions['1'].id").isEqualTo(6159088);
    }
    ...
    void testDeserialize() throws IOException {
        ...
        // Check status and generatedFrom
